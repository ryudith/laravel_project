...
<div class="flex justify-center">
    <div class="w-8/12 bg-white p-6 rounded-lg">
        <h3 class="text-4xl mb-6 text-center">Add Lend</h3>
        ...
        <form action="{{ route('lend.add') }}" method="post" enctype="multipart/form-data">
        @csrf
        ...
        <div class="mb-4" id="inputNameContainer">
            ...
            <input type="text" name="name" id="name" class="bg-gray-100 border-2 w-full p-4 rounded-lg mb-6 @error('name') border-red-500 @enderror" placeholder="Your name" value="{{ old('name') }}" />
        ...
        <div class="mb-4">
            ...
            <select name="status" id="status" class="bg-gray-100 border-2 w-full p-4 rounded-lg mb-6 @error('status') border-red-500 @enderror">
                ...
                <option value="1"@if(old('status') == '1' || ! old('status')) selected @endif>Unpaid</option>
                <option value="2"@if(old('status') == '2') selected @endif>Paid</option>
            </select>
        ...
        <div class="mb-4">
            ...
            <input type="number" name="nominal" id="nominal" class="bg-gray-100 border-2 w-full p-4 rounded-lg mb-6 @error('nominal') border-red-500 @enderror" placeholder="Lend nominal" value="{{ old('nominal') }}" />
        ...
        <div class="mb-4">
            ...
            <textarea name="description" id="description" class="bg-gray-100 border-2 w-full p-4 rounded-lg mb-6 @error('description') border-red-500 @enderror" placeholder="Lend description">{{ old('description') }}</textarea>
